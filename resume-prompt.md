...
- `male_a / 中文男` 清亮度实验已生成但尚未固化默认：5090D run `male-a-brightness-experiment-20260618` 产出 A 当前中文男、B 更强 EQ、C 更强 EQ + 半音升调，已拷回本机 ignored `workspace/runs/male-a-brightness-experiment-20260618/variants/`；等待用户试听后决定是否替换 `male_a` 后处理。
