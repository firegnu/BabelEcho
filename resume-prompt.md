...
- 下一步计划见 `docs/plans/03-audio-first-asr/03-real-voice-profile-provider.md`：设计 confirmed alias 到跨集稳定中文 voice role 的私有映射 contract；不要进入原主播 voice clone，也不要把 embedding 用于 TTS。
