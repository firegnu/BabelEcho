...
- 人工 speaker 改名工具。
- 长音频 chunking。
- Private speaker alias 人工确认/审核 contract、confirmed alias 到稳定中文 voice role 的私有映射 contract、显式 opt-in 应用到单次 run 的 speaker_voices 已完成并完成 5090D smoke；显式配置开关已完成本机验证，后续补 5090D 配置开关 smoke。
